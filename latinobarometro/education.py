...
avg1995 = pd.to_numeric(venezuela1995['p58b'].map(mapping_1)).mean()
avg1996 = pd.to_numeric(venezuela1996['p62b'].map(mapping_1)).mean()
avg1997 = pd.to_numeric(venezuela1997['bp16b'].map(mapping_2)).mean()
avg1998 = pd.to_numeric(venezuela1998['sp76b'].map(mapping_1)).mean()
avg2000 = pd.to_numeric(venezuela2000['P18ST.B'].map(mapping_0)).mean()
avg2003 = pd.to_numeric(venezuela2003['p25nb'].map(mapping_3)).mean()
avg2004 = pd.to_numeric(venezuela2004['p39stb'].map(mapping_3)).mean()
avg2005 = pd.to_numeric(venezuela2005['p91stb'].map(mapping_3)).mean()
avg2006 = pd.to_numeric(venezuela2006['p80st.b'].map(mapping_3)).mean()
avg2007 = pd.to_numeric(venezuela2007['p57st.b'].map(mapping_3)).mean()
avg2009 = pd.to_numeric(venezuela2009['p71n.b'].map(mapping_3)).mean()
avg2010 = pd.to_numeric(venezuela2010['P65ST.B'].map(mapping_3)).mean()
avg2011 = pd.to_numeric(venezuela2011['P66ST.B'].map(mapping_3)).mean()
...
plt.xlabel('Year')
plt.ylabel('Average')
plt.title('Education satisfaction: 1 = Not at all satisfied , 4 = Very satisfied')
plt.grid(True)
plt.show()